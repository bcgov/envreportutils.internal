...
1) In your bash shell, make new directory for the new indicator in 
  `D:/git_server/[file_name]`, then create a *bare* git repo.  This will be the 
...
Trouble shooting - install_local sometimes conflicts with the same call in devtools so if you have trouble make sure devtools is not installed.
...
indicator file/folder structure. For local git server folders you can ignore the LICENSE file by using apache = FALSE. You can then open the project from RStudio 
