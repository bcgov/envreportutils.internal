...
% Above unaltered from https://raw.githubusercontent.com/jgm/pandoc/master/data/templates/default.latex

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % SoE Document template setup, don't change anything here
...
% END SOE Template stuff
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Removed from pandoc Template
% (Beamer stuff and document class)
...
% End chunk removed from pandoc template
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Replace last part of pandoc template with SoE stuff for
% populating headers

$if(topic)$
  \title{\vspace{-1cm}
         \flushleft{\includegraphics[height=50pt]{$topic$.png}
                    \hspace{0.3cm}\Huge{\topictitle{$topic$}}}
         \vspace{-0.5cm}
         \begin{center}
         \line(1,0){450}
         \end{center}
...
%%%%%%%%%%%%%%%
% Comment out last section of pandoc template, replaced 
% with above
